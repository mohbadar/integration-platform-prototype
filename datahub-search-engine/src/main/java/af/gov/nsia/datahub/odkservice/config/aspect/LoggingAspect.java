package af.gov.nsia.datahub.odkservice.config.aspect;

import af.gov.nsia.datahub.odkservice.util.Utility;
...
public class LoggingAspect {
    ...
    @Before("@annotation(af.gov.nsia.datahub.odkservice.config.aspect.Loggable)")
